...
class __TwigTemplate_f2122b03ac7073a0ad8e30a16828605784d2b6d15337fdf949e3e12a39ce78b9 extends \Twig\Template
{
                ...
                foreach ($context['_seq'] as $context["id"] => $context["particle"]) {
                    ...
                    if ( !$this->getAttribute($context["particle"], "hidden", [])) {
                        ...
                        if ($this->getAttribute($this->getAttribute($this->getAttribute($context["particle"], "form", []), "fields", []), "enabled", [])) {
                            // line 44
                            echo "                                            ";
                            $this->loadTemplate("forms/fields/enable/enable.html.twig", "@gantry-admin/pages/configurations/page/page.html.twig", 44)->display(array_merge($context, ["default" => true, "scope" => ($context["prefix"] ?? null), "name" => "enabled", "field" => $this->getAttribute($this->getAttribute($this->getAttribute($context["particle"], "form", []), "fields", []), "enabled", []), "value" => $this->getAttribute(($context["data"] ?? null), "get", [0 => (($context["prefix"] ?? null) . "enabled")], "method")]));
                            // line 45
                            echo "
                                            ";
                            // line 46
                            if (($context["overrideable"] ?? null)) {
                                // line 47
                                echo "                                                ";
                                $this->loadTemplate("forms/override.html.twig", "@gantry-admin/pages/configurations/page/page.html.twig", 47)->display(array_merge($context, ["scope" => ($context["prefix"] ?? null), "name" => "enabled", "field" => ["label" => (("Enabled of the " . $this->getAttribute($context["particle"], "name", [])) . " Particle")]]));
                                // line 48
                                echo "                                            ";
                            }
                            // line 49
                        ...
                        echo "                                    </h4>
                                    ...
                                    <div class=\"inner-params\">
                                        ";
                        // line 53
                        $this->loadTemplate("forms/fields.html.twig", "@gantry-admin/pages/configurations/page/page.html.twig", 53)->display(array_merge($context, ["ignore_not_overrideable" => true, "overrideable" => ($context["overrideable"] ?? null), "blueprints" => $this->getAttribute($context["particle"], "form", []), "skip" => [0 => "enabled"], "prefix" => ($context["prefix"] ?? null)]));
                        // line 54
                        echo "                                    </div>
                                </div>
                            ";
...
";
    ...
    {
        return new Source("", "@gantry-admin/pages/configurations/page/page.html.twig", "C:\\grav\\grav-admin\\user\\plugins\\gantry5\\admin\\templates\\pages\\configurations\\page\\page.html.twig");
    }
}
