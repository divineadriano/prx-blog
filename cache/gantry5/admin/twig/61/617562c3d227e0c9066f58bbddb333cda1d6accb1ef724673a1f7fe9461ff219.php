...
class __TwigTemplate_7a9873ac44506cdf5a36ed6326c76d61ca1937f7cb8780de0869d36850c9ce73 extends \Twig\Template
{
...
";
    ...
    public function block_overridable($context, array $blocks = [])
    {
        ...
        if ((($context["overrideable"] ?? null) && (($context["field_overridable"] ?? null) || ($context["has_value"] ?? null)))) {
            // line 26
            echo "            ";
            $this->loadTemplate("forms/override.html.twig", "forms/field.html.twig", 26)->display(array_merge($context, ["scope" => ($context["scope"] ?? null), "name" => ($context["name"] ?? null), "field" => ($context["field"] ?? null)]));
            // line 27
            echo "        ";
        }
        // line 28
    ...
    {
        return new Source("", "forms/field.html.twig", "C:\\grav\\grav-admin\\user\\plugins\\gantry5\\admin\\templates\\forms\\field.html.twig");
    }
}
