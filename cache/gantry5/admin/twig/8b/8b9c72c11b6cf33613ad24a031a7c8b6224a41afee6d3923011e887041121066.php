...
class __TwigTemplate_2e88a817d4440003c0fb4df57e3b8faeb799ffad5dd264f8a184bfe222209523 extends \Twig\Template
{
    ...
    <h4>
        ...
        if (($context["item"] ?? null)) {
            ...
            if ($this->getAttribute($this->getAttribute(($context["blueprints"] ?? null), "fields", []), "enabled", [])) {
                // line 15
                echo "                ";
                $this->loadTemplate("forms/fields/enable/enable.html.twig", "@gantry-admin/pages/configurations/layouts/particle-card.html.twig", 15)->display(array_merge($context, ["name" => (("particles." . ($context["item_type"] ?? null)) . ".enabled"), "field" => $this->getAttribute($this->getAttribute(($context["blueprints"] ?? null), "fields", []), "enabled", []), "value" => $this->getAttribute($this->getAttribute(($context["item"] ?? null), "attributes", []), "enabled", []), "default" => 1, "turned_off" => ($context["item_disabled"] ?? null)]));
                // line 16
                echo "            ";
            }
            // line 17
...
";
    ...
    {
        return new Source("", "@gantry-admin/pages/configurations/layouts/particle-card.html.twig", "C:\\grav\\grav-admin\\user\\plugins\\gantry5\\admin\\templates\\pages\\configurations\\layouts\\particle-card.html.twig");
    }
}
