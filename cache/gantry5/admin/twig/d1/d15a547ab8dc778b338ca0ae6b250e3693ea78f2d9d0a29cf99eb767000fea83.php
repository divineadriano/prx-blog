...
class __TwigTemplate_ee9e0c9c879e607914e2019deca2abab4de855e27f1de6195b0e7287cab531c6 extends \Twig\Template
{
...
($context["gantry"] ?? null), "outlines", []), "title", [0 => $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "outline", [])], "method")) . "</strong>"))) . "<br />ID: ") . $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "atom", [])) . "<br />Replace: ") . twig_join_filter($this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "include", []), ", ")) . "\"")) : (""));
        ...
        if (($context["overrideable"] ?? null)) {
            ...
            // line 44
            echo "            ";
            $this->loadTemplate("forms/override.html.twig", "@gantry-admin/pages/configurations/page/atoms.html.twig", 44)->display(array_merge($context, ["scope" => ($context["prefix"] ?? null), "name" => "atoms", "has_value" =>  !(null === $this->getAttribute(($context["data"] ?? null), "get", [0 => (($context["prefix"] ?? null) . "atoms")], "method")), "field" => ["label" => "Enabled of the field Atoms"]]));
            // line 45
            echo "        ";
        }
        // line 46
    ...
    {
        return new Source("", "@gantry-admin/pages/configurations/page/atoms.html.twig", "C:\\grav\\grav-admin\\user\\plugins\\gantry5\\admin\\templates\\pages\\configurations\\page\\atoms.html.twig");
    }
}
