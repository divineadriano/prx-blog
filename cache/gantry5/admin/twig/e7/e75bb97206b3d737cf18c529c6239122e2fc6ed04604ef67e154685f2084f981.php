...
class __TwigTemplate_ed31120a77f8b18ff81cdedd2a141344943d7718247a7288009f729b8d463508 extends \Twig\Template
{
    ...
    ";
        ...
        if (($this->getAttribute(($context["blueprints"] ?? null), "type", []) == "collection.list")) {
            ...
            <div class=\"inner-params\">
                ";
            // line 21
            $this->loadTemplate("forms/fields.html.twig", "@gantry-admin/pages/configurations/settings/field.html.twig", 21)->display(array_merge($context, ["skip" => [0 => ($context["title"] ?? null)]]));
            // line 22
            echo "            </div>
        </div>
    ";
...
";
    ...
    {
        return new Source("", "@gantry-admin/pages/configurations/settings/field.html.twig", "C:\\grav\\grav-admin\\user\\plugins\\gantry5\\admin\\templates\\pages\\configurations\\settings\\field.html.twig");
    }
}
