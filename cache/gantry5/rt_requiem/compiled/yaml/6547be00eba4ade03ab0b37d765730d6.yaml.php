...
return [
    ...
    'filename' => 'C:/grav/grav-admin/user/data/gantry5/themes/rt_requiem/config/menu/mainmenu.yaml',
    'modified' => 1553748709,
    'data' => [
        'settings' => [
            'title' => 'Mainmenu'
        ...
        'items' => [
            ...
            'category/sample-pages/our-team' => [
                'enabled' => true,
                'anchor_class' => ''
            ],
            'category/sample-pages/clients' => [
                'enabled' => true,
                'anchor_class' => ''
            ],
            'category/sample-pages/frequently-asked-questions' => [
                'enabled' => true,
                'anchor_class' => ''
            ],
            'styles/__particle' => [
