...
return [
    ...
    'filename' => 'C:/grav/grav-admin/user/data/gantry5/themes/rt_requiem/config/offline/index.yaml',
    'modified' => 1553751274,
    'data' => [
        'name' => 'offline',
        ...
        'particles' => [
            ...
            'infolist' => [
                'infolist-9415' => 'Offline - Header'
            ],
            'content' => [
                'system-content-1050' => 'Page Content'
            ],
            'custom' => [
                'custom-4719' => 'To Make Your Grav Website Offline'
            ],
            'branding' => [
