...
class __TwigTemplate_2751fb76b60ec11c1970aa31f9e61579fb1e4cb5db5036366608180f8ee8b5ea extends Twig_Template
{
            ...
            {% if slide.image %}
              <div class=\"site-banner-media\">
                <figure class=\"site-banner-thumbnail\" title=\"{{ slide.title }}\" itemprop=\"image\">
                  <img width=\"100%\" src=\"{{ theme_url }}/images/slideshow/{{ slide.image }}\" class=\"attachment-receptar-banner size-receptar-banner wp-post-image\" alt=\"{{ slide.title }}\"/>
                </figure>
              </div>
            {% endif %}
            {% if slide.title %}
...
", "partials/slider.html.twig", "C:\\grav-admin\\user\\themes\\receptar\\templates\\partials\\slider.html.twig");
    }
}
